...
INSERT INTO dbo.MainIndent(ShipId, BDesc, shipname, Code, SCode, Ordy, OrdM, OrdD, OnBr, DOI, Char, OrDt, Lstd, Inco, Mstr, Rnk, IsNm, RcvdDt, RcvdPrt, cancel, Suplr, extracted, extorder, Stts, SndDt, Cpy2, Cpy4, Fin, DlvryRqrd, SttsDt, StsId)
...
INSERT INTO dbo.SubIndent(Inco, Iinco, Impa, QttyRq, Item, Unit, StStk, ROB, QttyRcv, DRcvd, Rcvd, amount, prcvd, INo, OfRsd, BgIno)
