...
public class ConsumerTool extends Thread implements MessageListener, ExceptionListener {
	...
	System.out.println("Start time millis " + consumerTool.start);
        while (true) {
		...
		System.out.println("Total Elapsed time in ms : " + (System.currentTimeMillis() - startTime));
                break;
            }
    ...
    public void onMessage(Message message) {
        ...
        try {
		    ...
		    java.util.Date date= new java.util.Date();
                    System.out.println(new Timestamp(date.getTime()) + "[" + this.getName() + "] Received: '" + msg + "' (length " + length + ")");
                }
            } else {
                if (verbose) {
